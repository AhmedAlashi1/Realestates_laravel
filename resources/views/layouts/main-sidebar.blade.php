...
{{--                                    @endif--}}
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . $page='dashboard/clearance_cases') }}">
                    ...
                    <span class="side-menu__label" style=" font-weight: bold;">حالات المخالصة</span>
{{--                    <?php--}}
...
{{--            <li class="slide">--}}
{{--                <a class="side-menu__item" href="{{ url('/' . $page='services') }}">--}}
{{--                    <img class="side-menu__icon" src="{{url('https://img.icons8.com/nolan/64/services.png')}}" style=" width: 30px; height: 30px;"/>--}}
{{--                    <span class="side-menu__label" style=" font-weight: bold;">حالة الطلبات</span></a>--}}
{{--            </li>--}}
